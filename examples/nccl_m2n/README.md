...
retry, and representative configuration validation. Native M2N transport is
mocked; use the example above for actual NCCL integration verification.
...
pytest -q test/srt/test_nccl_m2n_receiver.py \
